...
const Hero = () => {
  return (
    <section className="pt-16 px-[1rem] lg:px-[4rem] bg-white text-gray-900 overflow-hidden" data-name="hero" data-file="components/Hero.js">
        <div className="max-w-7xl flex flex-col lg:flex-row lg:mx-auto text-gray-900">
          <div className="text-center lg:text-left mb-16">
            ...
            <p className="text-xl md:text-xl text-[var(--text-secondary)] mb-10 max-w-3xl leading-relaxed">
              Buy and Sell Crypto with Jericho AI Agent on WhatsApp. From crypto to cash in seconds. Just text. It's that easy
            </p>
